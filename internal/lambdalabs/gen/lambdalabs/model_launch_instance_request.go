...
type _LaunchInstanceRequest LaunchInstanceRequest
...
func (o *LaunchInstanceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLaunchInstanceRequest := _LaunchInstanceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLaunchInstanceRequest)

	if err != nil {
		return err
	}

	*o = LaunchInstanceRequest(varLaunchInstanceRequest)
