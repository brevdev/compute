...
// checks if the AutoDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoDelete{}

// AutoDelete Set a date or spend threshold to automatically delete the instance
...
func (o AutoDelete) MarshalJSON() ([]byte, error) {
...
func (o AutoDelete) ToMap() (map[string]interface{}, error) {
...
func (o *AutoDelete) UnmarshalJSON(data []byte) (err error) {
	varAutoDelete := _AutoDelete{}

	err = json.Unmarshal(data, &varAutoDelete)

	if err != nil {
		return err
	}

	*o = AutoDelete(varAutoDelete)
...
type NullableAutoDelete struct {
	value *AutoDelete
	isSet bool
}

func (v NullableAutoDelete) Get() *AutoDelete {
	return v.value
}

func (v *NullableAutoDelete) Set(val *AutoDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoDelete(val *AutoDelete) *NullableAutoDelete {
	return &NullableAutoDelete{value: val, isSet: true}
}

func (v NullableAutoDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
